 ...
 */
class EuSqmaxController extends Zend_Controller_Action {
    ...
    public function init() {
        ...
        $menu = "<li><a href=\" /eu-sqmax/new \">Nouveau</a></li>";
    ...
    public function dataAction() {
        ...
        $select->where('code_param = ?','sqmaxui');
