   ...
   public function agenceAction() {
    ...
    public function groupeAction()   {
		...
		elseif ($code_group == 'detentrice')  {
		        $greg = array('gsnp_nn','gsn_nn','gsn_cnp','gsn_fn','gsn_smc','fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc','enrolement','gacs','gacex','gacdm'
				,'gacsz','gacexz','gacdp','detentrice_technopole','agrement_technopole','surveillance_filiere','agrement_filiere','executante_acnev','agrement_acnev'
				,'tableau_bord','rpgr_nonconso','ir_nonconso','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi','parametre','escompte','compensation','mprg'); 
                foreach($group as $value) {
                    if (in_array($value->code_groupe, $greg)) {
                       $g[$i][0] = $value->code_groupe;
                       $g[$i][1] = ucfirst(utf8_encode($value->libelle_groupe));
		...
		elseif ($code_group == 'detentrice_monde')  {
                    $greg = array('fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc','enrolement','gacsm','gacexm','gacdz',
					'detentrice_technopole','agrement_technopole','surveillance_filiere','agrement_filiere','executante_acnev','agrement_acnev',
					'tableau_bord','rpgr_nonconso','ir_nonconso','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi','escompte','compensation','mprg');            
                foreach($group as $value) {
                    if (in_array($value->code_groupe, $greg)) {
                       $g[$i][0] = $value->code_groupe;
                       $g[$i][1] = ucfirst(utf8_encode($value->libelle_groupe));
		...
		elseif ($code_group == 'detentrice_zone')  {
                    $greg = array('fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc','enrolement','gacsz','gacexz','gacdp',
					'detentrice_technopole','agrement_technopole','surveillance_filiere','agrement_filiere','executante_acnev','agrement_acnev',
					'tableau_bord','rpgr_nonconso','ir_nonconso','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi','escompte','compensation','mprg');            
                foreach ($group as $value) {
                    if (in_array($value->code_groupe, $greg)) {
		...
		elseif ($code_group == 'detentrice_pays')  {
                    $greg = array('fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc','paraenro','enrolement','gacsp','gacexp','gacdregion',
					'detentrice_technopole','agrement_technopole','surveillance_filiere','agrement_filiere','executante_acnev','agrement_acnev',
					'tableau_bord','rpgr_nonconso','ir_nonconso','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi','escompte','compensation','mprg');            
                foreach ($group as $value) {
                    if (in_array($value->code_groupe, $greg)) {
		...
		elseif ($code_group == 'detentrice_region')  {
                    $greg = array('fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc','enrolement','gacsregion','gacexregion','gacdsecteur',
					'detentrice_technopole','agrement_technopole','surveillance_filiere','agrement_filiere','executante_acnev','agrement_acnev',
					'tableau_bord','rpgr_nonconso','ir_nonconso','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi');            
                foreach ($group as $value) {
                    if (in_array($value->code_groupe, $greg)) {
                       $g[$i][0] = $value->code_groupe;
                       $g[$i][1] = ucfirst(utf8_encode($value->libelle_groupe));
		...
		elseif ($code_group == 'detentrice_secteur')  {
                    $greg = array('fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc','enrolement','gacssecteur','gacexsecteur','gacdagence',
					'detentrice_technopole','agrement_technopole','surveillance_filiere','agrement_filiere','executante_acnev','agrement_acnev',
					'tableau_bord','rpgr_nonconso','ir_nonconso','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi');            
                foreach ($group as $value) {
                    if (in_array($value->code_groupe, $greg)) {
                ...
                $greg = array('fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc','enrolement','gacsagence','gacexagence',
				'detentrice_technopole','agrement_technopole','surveillance_filiere','agrement_filiere','executante_acnev','agrement_acnev',
				'tableau_bord','rpgr_nonconso','ir_nonconso','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi');            
                foreach ($group as $value) {
                    if (in_array($value->code_groupe, $greg)) {
		        ...
		        $greg = array('SIF','fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc',
				'surveillance_filiere','agrement_filiere','detentrice_technopole','agrement_technopole','executante_acnev','agrement_acnev'
				,'domiciliation','tableau_bord','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti_nn','fn_ti_nr','fn_ti_nb','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi','collecte','repartition','escompte','compensation','mprg');
			    foreach ($group as $value) {
					    if (in_array($value->code_groupe, $greg)) {
                           $g[$i][0] = $value->code_groupe;
                           $g[$i][1] = ucfirst(utf8_encode($value->libelle_groupe));
		...
		elseif ($code_group == 'surveillance_pays') {
		        ...
		        $greg = array('SIF','fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc',
				'surveillance_filiere','agrement_filiere','detentrice_technopole','agrement_technopole','executante_acnev','agrement_acnev'
				,'domiciliation','tableau_bord','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti_nn','fn_ti_nr','fn_ti_nb','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi','collecte','repartition');
			    foreach ($group as $value) {
					    if (in_array($value->code_groupe, $greg)) {
                           $g[$i][0] = $value->code_groupe;
                           $g[$i][1] = ucfirst(utf8_encode($value->libelle_groupe));
		...
		elseif  ($code_group == 'executante') {
                    $greg = array('fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc','tableau_bord','nn_tegcp_pbf',
					'executante_acnev','agrement_acnev','surveillance_filiere','agrement_filiere','detentrice_technopole','agrement_technopole'
					,'cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi','escompte','compensation','mprg');
                    foreach ($group as $value) {
					    if (in_array($value->code_groupe, $greg)) {
                            $g[$i][0] = $value->code_groupe;
                            $g[$i][1] = ucfirst(utf8_encode($value->libelle_groupe));
		...
		elseif($code_group == 'executante_monde') {
                    $greg = array('fgp_nn','fg_nn','fg_cnp','fg_fn','fg_smc','e_nn','e_cnp','e_fn','e_smc','tableau_bord','nn_tegcp_pbf','cnp_tegcp_pbf','cnp_tegcp','cnp_tegcsc','fn_ti','smc_tpn','smc_tesmcipnp','smc_tesmcipnwi','escompte','compensation','mprg',
					'executante_acnev','agrement_acnev','surveillance_filiere','agrement_filiere','detentrice_technopole','agrement_technopole');
                    foreach ($group as $value) {
					    if (in_array($value->code_groupe, $greg)) {
                            $g[$i][0] = $value->code_groupe;
	...
	public function newAction()   {
        ...
        try {
			...
			elseif($code_membre != null && count($membre5) == 0) {
                 ...
                 $userin->setRole($this->_request->getPost("role"));
                 $userin->setSection($this->_request->getPost("section"));				 
        ...
        if ($this->getRequest()->isPost()) {
            ...
            /*} elseif ($pwd != $pwd1) {
                   ...
                   //$userin->setCode_zone($code_zone);
					...
					$userin->setRole($_POST['role']);
					$userin->setSection($_POST['section']);
