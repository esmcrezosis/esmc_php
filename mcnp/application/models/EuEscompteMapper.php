...
class Application_Model_EuEscompteMapper {
    ...
    public function getDbTable() {
        if (NULL === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_EuEscompte');
        }
        return $this->_dbTable;
    }

    public function save(Application_Model_EuEscompte $escompte) {
        $data = array(
    ...
    public function update(Application_Model_EuEscompte $escompte) {
        $data = array(
            'id_escompte' => $escompte->getId_escompte(),
            'code_compte' => $escompte->getCode_compte(),
            'code_membre' => $escompte->getCode_membre(),
    ...
    public function find($id_escompte, Application_Model_EuEscompte $escompte) {
    ...
    public function findByCategorieCompte($compte, $categorie, Application_Model_EuEscompte $escompte) {
        $select = $this->getDbTable()->select();
    ...
    public function findEscompte($compte) {
        $table = new Application_Model_DbTable_EuEscompte();
        $select = $table->select();
        ...
        foreach ($result as $row) {
            $entry = new Application_Model_EuEscompte();
