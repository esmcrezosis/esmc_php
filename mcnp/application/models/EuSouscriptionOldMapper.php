...
class Application_Model_EuSouscriptionOldMapper {
    ...
    public function getDbTable() {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_EuSouscriptionOld');
        }
        return $this->_dbTable;
    }

    public function find($souscription_id, Application_Model_EuSouscriptionOld $souscription) {
    ...
    public function fetchAll() {
        ...
        foreach ($resultSet as $row) {
            $entry = new Application_Model_EuSouscriptionOld();
    ...
    public function save(Application_Model_EuSouscriptionOld $souscription) {
        $data = array(
    ...
    public function update(Application_Model_EuSouscriptionOld $souscription) {
        $data = array(
            'souscription_nom' => $souscription->getSouscription_nom(),
            'souscription_prenom' => $souscription->getSouscription_prenom(),
            'souscription_mobile' => $souscription->getSouscription_mobile(),
    ...
    public function fetchAllByTableauBord($publier, $souscription_type = "", $souscription_banque = "", $souscription_personne = "", $souscription_nombre = 0, $souscription_programme = "", $souscription_type_candidat = 0, $code_type_acteur = "", $code_statut = "", $code_activite = 0, $id_metier = 0, $id_competence = 0, $id_canton = 0, $id_prefecture = 0, $id_region = 0, $id_pays = 0, $code_zone = "") {
        $select = $this->getDbTable()->select();
		$select->where("publier = ? ", $publier);
    ...
    public function fetchAllByTableauBordTotal($publier, $souscription_type = "", $souscription_banque = "", $souscription_personne = "", $souscription_nombre = 0, $souscription_programme = "", $souscription_type_candidat = 0, $code_type_acteur = "", $code_statut = "", $code_activite = 0, $id_metier = 0, $id_competence = 0, $id_canton = 0, $id_prefecture = 0, $id_region = 0, $id_pays = 0, $code_zone = "") {
        $select = $this->getDbTable()->select();
    ...
    public function fetchAllByTableauBordReactivation($publier, $souscription_type = "", $souscription_banque = "", $souscription_personne = "", $souscription_nombre = 0, $souscription_programme = "", $souscription_type_candidat = 0, $code_type_acteur = "", $code_statut = "", $code_activite = 0, $id_metier = 0, $id_competence = 0, $id_canton = 0, $id_prefecture = 0, $id_region = 0, $id_pays = 0, $code_zone = "") {
        $select = $this->getDbTable()->select();
		$select->where("publier = ? ", $publier);
		if($souscription_type != "") {
			$select->where("souscription_type = ? ", $souscription_type);
    ...
    public function fetchAllByTableauBordReactivationTotal($publier, $souscription_type = "", $souscription_banque = "", $souscription_personne = "", $souscription_nombre = 0, $souscription_programme = "", $souscription_type_candidat = 0, $code_type_acteur = "", $code_statut = "", $code_activite = 0, $id_metier = 0, $id_competence = 0, $id_canton = 0, $id_prefecture = 0, $id_region = 0, $id_pays = 0, $code_zone = "") {
        $select = $this->getDbTable()->select();
        $select->from($this->getDbTable(), array('SUM(souscription_montant) as COUNT'));
		$select->where("publier = ? ", $publier);
		if($souscription_type != "") {
    ...
    public function fetchAllByPublierErreur($publier, $code_agence = "") {
        $select = $this->getDbTable()->select();
		$select->where("publier = ? ", $publier);
		$select->where("erreur = ? ", 1);
		if($code_agence != "") {
