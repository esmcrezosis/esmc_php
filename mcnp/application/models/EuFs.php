...
class Application_Model_EuFs {
	...
	function getOrigine_fs() {
        return $this->origine_fs;
    }

    function setOrigine_fs($origine_fs) {
        $this->origine_fs =  $origine_fs;
        return $this;
    }
    ...
    public function exchangeArray($data) {
		...
		$this->origine_fs = (isset($data['origine_fs'])) ? $data['origine_fs'] : NULL;
