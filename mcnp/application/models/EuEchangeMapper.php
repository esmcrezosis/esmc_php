 ...
 * @author user
 */
class Application_Model_EuEchangeMapper {
    ...
    public function getDbTable() {
        if (NULL === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_EuEchange');
        }
        return $this->_dbTable;
    }

    public function find($id_echange, Application_Model_EuEchange $echange) {
    ...
    public function fetchAll() {
        ...
        foreach ($resultSet as $row) {
            $entry = new Application_Model_EuEchange();
    ...
    public function save(Application_Model_EuEchange $echange) {
        $data = array(
            'id_echange' => $echange->getId_echange(),
            'code_membre' => $echange->getCode_membre(),
			'code_membre_morale' => $echange->getCode_membre_morale(),
    ...
    public function update(Application_Model_EuEchange $echange) {
        $data = array(
            'id_echange' => $echange->getId_echange(),
            'code_membre' => $echange->getCode_membre(),
			'code_membre_morale' => $echange->getCode_membre_morale(),
