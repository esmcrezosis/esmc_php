...
class Application_Model_EuPoste {

    //put your code here
    protected $poste_id;
    protected $poste_tache;
    protected $poste_utilisateur;
    ...
    public function getPoste_utilisateur() {
        return $this->poste_utilisateur;
    }

    public function setPoste_utilisateur($poste_utilisateur) {
        $this->poste_utilisateur = $poste_utilisateur;
        return $this;
    }
