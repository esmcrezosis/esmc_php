...
class Application_Model_EuPubliciteMapper {
    ...
    public function find($id_publicite, Application_Model_EuPublicite $publicite) {
        ...
        $publicite->setId_publicite($row->id_publicite)
                ...
                ->setAncien_publicite($row->ancien_publicite)
    ...
    public function save(Application_Model_EuPublicite $publicite) {
        $data = array(
            ...
            'ancien_publicite' => $publicite->getAncien_publicite(),
    ...
    public function fetchAll4($type_publicite) {
        ...
        public function fetchAll6($ancien_publicite) {
        $select = $this->getDbTable()->select();
        $select->where("ancien_publicite = ? ", $ancien_publicite);
        //$select->order("rand()");
        $resultSet = $this->getDbTable()->fetchAll($select);
        $entries = array();
        foreach ($resultSet as $row) {
    ...
    public function fetchAllByTypeCategorieBoxInterfaceAncien($type_publicite = 0, $categorie_publicite = 0, $box_publicite = 0, $interface_publicite = 0, $ancien_publicite = 0) {
        $select = $this->getDbTable()->select();
        if($type_publicite > 0){
        $select->where("type_publicite = ? ", $type_publicite);            
        }
    ...
    public function fetchAllByTypeCategorieBoxInterfaceAncienMenu($type_publicite = 0, $categorie_publicite = 0, $box_publicite = 0, $interface_publicite = 0, $ancien_publicite = 0, $limit = 0) {
        $select = $this->getDbTable()->select();
        if($type_publicite > 0){
        $select->where("type_publicite = ? ", $type_publicite);            
        }
    ...
    public function fetchAllByTypeCategorieBoxInterfaceAncienOne($type_publicite = 0, $categorie_publicite = 0, $box_publicite = 0, $interface_publicite = 0, $ancien_publicite = 0) {
        $select = $this->getDbTable()->select();
        if($type_publicite > 0){
        $select->where("type_publicite = ? ", $type_publicite);            
        }
