 ...
 * @author user
 */
class Application_Model_EuCartes {
    //put your code here
     //put your code here
	...
	function getOrigine_fkps() {
        return $this->origine_fkps;
    }

    function setOrigine_fkps($origine_fkps) {
        $this->origine_fkps = $origine_fkps;
        return $this;
    }
    ...
    public function exchangeArray($data) {
		...
		$this->origine_fkps = (isset($data['origine_fkps'])) ? $data['origine_fkps'] : NULL;
    }
    ...
    public function toArray() {
        $data = array(
			...
			'origine_fkps' => $this->origine_fkps
        );
        return $data;
    }
    ...
    public function findConuter() {
        $t_cartes = new Application_Model_DbTable_EuCartes();
