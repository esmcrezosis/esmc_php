...
class Application_Model_EuTypeIntegrateurMapper {
    ...
    public function fetchAllByTravailler()  {
       $select = $this->getDbTable()->select();
       $select->where("id_type_integrateur IN (?) ", array(1,2,3,4,5,6,7,8,15,16,17,18,19,20,22,23,25,26,27,28,29,30));
       $resultSet = $this->getDbTable()->fetchAll($select);
