...
class Application_Model_EuMstiersListecmMapper {
	...
	public function fetchAllBeneficiaireAvecListe()  {
	   ...
	   //$select->where('code_membre_apporteur is not null');
    ...
    public function save(Application_Model_EuMstiersListecm $mstierslistecm) {
        $data = array(
			...
			'nom_membre' => $mstierslistecm->getNom_membre(),
			'prenom_membre' => $mstierslistecm->getPrenom_membre(),
			'date_nais_membre' => $mstierslistecm->getDate_nais_membre(),
			'lieu_nais_membre' => $mstierslistecm->getLieu_nais_membre(),
			'mere_membre' => $mstierslistecm->getMere_membre(),
            'pere_membre' => $mstierslistecm->getPere_membre(),
			...
			'quartier_membre' => $mstierslistecm->getQuartier_membre(),
			'sexe_membre' => $mstierslistecm->getSexe_membre(),
			'sitfam_membre' => $mstierslistecm->getSitfam_membre(),
			'ville_membre' => $mstierslistecm->getVille_membre(),
			...
			'profession_membre'  =>  $mstierslistecm->getProfession_membre(),
