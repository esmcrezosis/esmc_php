...
class Application_Model_EuCompteMapper {
    ...
    public function getDbTable() {
        if (NULL === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_EuCompte');
        }
    ...
    public function save(Application_Model_EuCompte $compte) {
        $data = array(
            ...
            'numero_carte' => $compte->getNumero_carte()
        );

        $this->getDbTable()->insert($data);
    }

    public function update(Application_Model_EuCompte $compte) {
        $data = array(
            'code_membre' => $compte->getCode_membre(),
            'solde' => $compte->getSolde(),
            'lib_compte' => $compte->getLib_compte(),
    ...
    public function find($num_compte, Application_Model_EuCompte $compte) {
