    ...
    try {
        ...
        if(($lignesbeneficiaire != NULL) && (count($lignesbeneficiaire) > 0)) {
            ...
            while($i < $nbre_lignesbeneficiaire) {
                $code_caps = $type_bnp.$date_deb->toString('yyyyMMddHHmmss');
                $lignebeneficiaire = $lignesbeneficiaire[$i];
                $lignesmstiers = $m_mstiers->fetchAllMstiersSansListe();
                $cumulsolde = $m_mstiers->findcumulMstiersSansListe();
