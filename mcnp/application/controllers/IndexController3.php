...
if (is_dir($dir)) {
	...
	public function reglerrpgiAction() {
		    ...
		    if (isset($_POST['ok']) && $_POST['ok']=="ok") {
				...
				$this->view->gcps = $tab_gcp->fetchAll($select);
			    $this->view->code_membre    = $code_membre;
			...
			if  (isset($_POST['ok1']) && $_POST['ok1']=="ok1") {
		        ...
		        if($response) {
				  $sessionmcnp->errorlogin = "Reglement effectué avec succès ...";
				}   
                $this->_redirect('/index/reglerrpgi');
	        }
	}
	...
	public function reglermf11000Action() {
		    ...
		    if (isset($_POST['ok']) && $_POST['ok']=="ok") {
                if (isset($_POST['num_bon']) && $_POST['num_bon']!="") {
				   ...
				   $this->view->mf11000 = $tabela->fetchAll($select);
			       $this->view->num_bon    = $num_bon;
	            }	
			}
			...
			if  (isset($_POST['ok1']) && $_POST['ok1']=="ok1") {
				...
				if($response) {
				  $sessionmcnp->errorlogin = "Règlement effectué avec succès ...";
				} 				
                $this->_redirect('/index/reglermf11000');
	...
	public function recouvrermf11000Action() {
			...
			if  (isset($_POST['ok1']) && $_POST['ok1']=="ok1") { 
	            ...
	            if($response) {
				  $sessionmcnp->errorlogin = "Recouvrement effectué avec succès ...";
				}   
                $this->_redirect('/index/recouvrermf11000');
	        }		
    ...
    public function recouvrerrpgiAction() {
			...
			if  (isset($_POST['ok1']) && $_POST['ok1']=="ok1") {
                ...
                $this->_redirect('/index/recouvrerrpgi');	
            }			
