        ...
        if (isset($_POST['code_membre']) && $_POST['code_membre']!="") {
            ...
            if(count($memb) > 0) {
                ...
                if(count($sous) > 0) {
                   ...
                   $this->view->message = "Vous devez faire la réactivation ...";
                }				
			  ...
			  && isset($_POST['souscription_montant']) && $_POST['souscription_montant']!="") 
			{
				...
				try {
					...
					if (count($rowseusouscription) > 0 && $_POST['souscription_login'] != "" && $souscription_ok == 0) {
					    ...
					    $souscription->setSouscription_ancien_membre(null);
                        ...
                        $html .= "Biens, Produits et Services : ".$activite->nom_activite."<br/>";

                        $metierM = new Application_Model_DbTable_EuMetier();
                        $metier = $metierM->find($_POST['id_metier']);
                        $html .= "Métier : ".$metier->libelle_metier."<br/>";
                        ...
                        $html .= "<br/>";
                        $html .= "Connectez vous ici : <a href='http://esmcgacsource.com/souscription/login'>Connexion Souscription</a>";
                        ...
                        <tbody>
                            <tr>
                                <td colspan="4"><img src="'.Util_Utils::getParamEsmc(1).'/images/entete.gif" width="738" height="156" /></td>
                            </tr>';
						$souscription = new Application_Model_EuSouscription();
...
$sessionmcnp->error = "Opération bien effectuée";
		$this->_redirect('/index/listsouscription');/**/
	}
...
$newfile = "pdf_releve/RELEVE_CNCS_".str_replace("/", "_", mettreaccents($membre)."_".str_replace("/", "_", mettreaccents($date_id->toString('ddMMyyyyHHmmss')))).".html"	;
...
$newfile = "pdf_releve/RELEVE_VERIF_RPGI_".str_replace("/", "_", mettreaccents($membre)."_".str_replace("/", "_", mettreaccents($date_id->toString('ddMMyyyyHHmmss')))).".html"	;
...
$newfile = "pdf_releve/RELEVE_CNP_".str_replace("/", "_", mettreaccents($membre)."_".str_replace("/", "_", mettreaccents($date_id->toString('ddMMyyyyHHmmss')))).".html"	;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (isset($_POST['ok1']) && $_POST['ok1']=="ok1") {
        ...
        $dir = "pdf_releve/";
        $findme = "RELEVE_CNCS_".$code_membre;
        if (is_dir($dir)) {
            if ($dh = opendir($dir)) {
            while (($file = readdir($dh)) !== false) {
			    ...
			    //$rel = $ma->fetchAllByType('CNCS',$code_membre);
				//$rel = $rel[0];
				//if($rel == NULL ) {
				...
				//} else {
                //$findreleve = $ma->find($rel->releve_id,$a);
				//$a->setReleve_fichier($releve);
				//$a->setPublier($_POST['publier']);
				//$ma->update($a);
                //}
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (isset($_POST['ok1']) && $_POST['ok1']=="ok1") {
        ...
        if (is_dir($dir)) {
            ...
            while (($file = readdir($dh)) !== false) {
				...
				//$rel = $ma->fetchAllByType('SALAIRE',$code_membre);
				//$rel = $rel[0];
				//if($rel == NULL ) {
    ...
    public function relevegievalidationcreditAction() {
        ...
        if (isset($_POST['ok1']) && $_POST['ok1']=="ok1")  {
            ...
            $dir = "pdf_releve/";
            $findme = "RELEVE_CNP_".$code_membre;
            if (is_dir($dir)) {
                if ($dh = opendir($dir)) {
                while (($file = readdir($dh)) !== false) {
			        $nomfile = basename($file).PHP_EOL;
			        if(stripos($nomfile, $findme) !== false) {
						...
						//$rel = $ma->fetchAllByType('CNP',$code_membre);
				        //$rel = $rel[0];
				        //if($rel == NULL ) {
        ...
        if (is_dir($dir)) {
            ...
            while (($file = readdir($dh)) !== false) {
			    ...
			    if(stripos($nomfile, $findme) !== false) {
			        ...
			        //$rel = $ma->fetchAllByType('RPG_I',$code_membre);
				    //$rel = $rel[0];
				    //if($rel == NULL ) {
            ...
            if ($dh = opendir($dir)) {
                while (($file = readdir($dh)) !== false) {
			        ...
			        if(stripos($nomfile, $findme) !== false) {
						...
						//$rel = $ma->fetchAllByType('GCP',$code_membre);
				        //$rel = $rel[0];
				        //if($rel == NULL ) {
        ...
        if (is_dir($dir)) {
            ...
            while (($file = readdir($dh)) !== false) {
			    ...
			    if(stripos($nomfile, $findme) !== false){
			        ...
			        //$rel = $ma->fetchAllByType('FS_FL_FCPS',$code_membre);
				    //$rel = $rel[0];
...
////////////////////////////////////////////////////////////////////////////////
        ...
        $a = new Application_Model_EuReleve();
        $ma = new Application_Model_EuReleveMapper();
		$relev = $ma->fetchAllByTypeMembre("MF11000_PP", $num_bon);
		if(count($relev) > 0){
			$this->view->trouve    = 1;
			}
    ...
    if (isset($_POST['ok1']) && $_POST['ok1']=="ok1") {
        ...
        $dir = "pdf_releve/";
        $findme = "RELEVE_MF11000_PP_".$num_bon;
        if (is_dir($dir)) {
            if ($dh = opendir($dir)) {
                while (($file = readdir($dh)) !== false) {
			        $nomfile = basename($file).PHP_EOL;
			        if(stripos($nomfile, $findme) !== false) {
			            ...
			            //$rel = $ma->fetchAllByType('MF11000_PP',$num_bon);
				        //$rel = $rel[0];
        ...
        if ($dh = opendir($dir)) {
            while (($file = readdir($dh)) !== false) {
			    ...
			    if(stripos($nomfile, $findme) !== false) {
					...
					//$rel = $ma->fetchAllByType('MF11000_PM',$code_membre);
				    //$rel = $rel[0];
            ...
            if ($dh = opendir($dir)) {
                while (($file = readdir($dh)) !== false) {
			        ...
			        if(stripos($nomfile, $findme) !== false) {
						...
						//$rel = $ma->fetchAllByType('MF107',$code_membre);
				        //$rel = $rel[0];
