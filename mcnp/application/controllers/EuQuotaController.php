 ...
 */
class EuQuotaController extends Zend_Controller_Action {
    ...
    public function init() {
        ...
        $menu = "<li><a href=\" /eu-quota/new \">Nouveau</a></li>";
    ...
    public function newAction() {
        ...
        $form = new Application_Form_EuQuota();
        if ($this->getRequest()->isPost()) {
            if ($form->isValid($request->getPost())) {
               ...
               $count = $mapper->findConuterquota();
                   if ($count == 1) {
                      $message = 'Le paramétrage du quota est déjà défini.';
